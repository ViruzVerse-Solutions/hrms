      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
        ...
        <div className="relative hidden sm:block w-36 sm:w-56 md:w-72 lg:w-80">
          ...
          <input
            ...
            className="w-full h-8 sm:h-9 pl-8 sm:pl-9 pr-3 rounded-xl text-xs bg-slate-100 border border-slate-200 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:bg-white focus:border-indigo-300 transition-all"
          />
        </div>
      </div>
