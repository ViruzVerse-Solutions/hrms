...
export async function GET(req: NextRequest) {
  try {
    ...
    const formatPayslip = (ps: any) => ({
      ...
      employeeName: ps.employee ? `${ps.employee.firstName} ${ps.employee.lastName}` : 'Vishwadharan R',
      designation: ps.employee?.designationTitle || 'Senior Analytical Chemist & QC Specialist',
      department: ps.employee?.departmentName || 'Quality Assurance & Analytical Lab',
      period: ps.period,
      paidDays: 30,
      lopDays: 0,
      breakup: {
